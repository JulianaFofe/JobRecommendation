...
export default function FeedbackPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setSubmitted(true);
    setTimeout(() => setSubmitted(false), 6000); // Reset after 4s
  };
        ...
        {!submitted ? (
          <>
            ...
            <p className="text-gray-600 text-center mb-8">
              Help us improve SmartHire by sharing your thoughts. Your feedback
              makes a difference!
            </p>
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star
                      ...
                      className={`cursor-pointer transition ${
                        star <= rating ? "fill-secondary text-secondary" : "text-gray-400"
                      }`}
          ...
          >
            ...
            <p className="text-gray-600">
              Your feedback has been received. We appreciate your time and will
              use your insights to make SmartHire even better!
            </p>
          </motion.div>
        )}
      </motion.div>
